...
HTMLInputElement get _hintsBox =>
    document.getElementById('hints')! as HTMLInputElement;
...
Future<void> main() async {
  ...
  _hintsBox.onChange.listen((_) {
    unawaited(
      _save(_settings.copyWith(showFieldHints: _hintsBox.checked)),
    );
  });
...
void _applyToControls() {
  ...
  _hintsBox.checked = _settings.showFieldHints;
