...
final class CloudflareField {
  ...
  /// A native tooltip for the whole row, or null.
  ///
  ...
  /// own regardless: a tooltip needs a mouse and the suspicion that
  /// there is something to hover over, which is exactly what a reader
  /// who is confused does not have.
  final String? hint;
}
