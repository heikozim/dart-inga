...
///
/// Each state has TWO drawings, and `tool/render_icons.sh` says which
/// size takes which: `inga-<state>-small.svg` for the 16 and 32 px the
/// toolbar reads, without the legs that only become haze there, and
/// `inga-<state>.svg` for 48 and 128.
enum IconState {
